  ...
  private Sistema sistema;
   ...
   private VentanaMenu vm;
    ...
    private void initComponents() {
        ...
        jug.addMouseListener(new java.awt.event.MouseAdapter() {
        ...
        volver.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/espalda.png"))); // NOI18N
    ...
    private void jugarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jugarActionPerformed
        ...
        if((nombre1.getText().equals(nombre2.getText()) && !nombre1.getText().isEmpty()) || (nombre2.getText().equals(nombre1.getText()) && !nombre2.getText().isEmpty())){
            JOptionPane.showMessageDialog(this,"No se puede jugar contra uno mismo","No",0);
        }else if (nombre1.getText().isEmpty() || nombre2.getText().isEmpty()){
            JOptionPane.showMessageDialog(this,"No se puede jugar si no hay 2 jugadores seleccionados","Error", 0);
            ...
            VentanaTablero vt = new VentanaTablero(this.time,this.getSistema(),this.getJuego() , musica.getSelectedValue(),this.getVm());
