...
public class ReanudarPartida extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    volver.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/Imagenes/flecha-atras (1).png"))); // NOI18N
    ...
    jLabel3.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Imagenes/saveroomRE.jpg"))); // NOI18N
  ...
  private void reanudarActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_reanudarActionPerformed
    if (this.partidasGuardadas.getSelectedValue() == null) {
      ...
      reanudada.getJugador1().setFichas(pg.getJugador1().getFichas());
      reanudada.getJugador2().setFichas(pg.getJugador2().getFichas());

      VentanaTablero vt =
          new VentanaTablero(
              pg.isTiempo(), this.getSistema(), reanudada, pg.getCancion(), this.getVm());
