...
public class Rankings extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    Volver.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/Imagenes/flecha-atras (1)_1.png"))); // NOI18N
    ...
    crearExcel.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Imagenes/sobresalir.png"))); // NOI18N
    crearExcel.setText("Crear Excel con rankings");
    crearExcel.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jLabel2.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Imagenes/rankings.jpg"))); // NOI18N
  ...
  private void rankingsMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_rankingsMouseClicked
  ...
  private void crearExcelActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_crearExcelActionPerformed
    ...
    // aca en i estoy creando las filas del excel (Ya que el archivo es una matriz de filas y las
    // celdas son las columnas.
    for (int i = 1; i < (largoExcel + 1); i++) {
      ...
      for (int j = 0; j < encabezados.length; j++) {
        // ahora estoy creando las columnas (las Cells son las columnas ) y poniendole sus datos
