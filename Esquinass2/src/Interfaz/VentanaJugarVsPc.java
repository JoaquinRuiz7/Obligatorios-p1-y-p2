...
public class VentanaJugarVsPc extends javax.swing.JFrame implements Serializable {
  ...
  private void initComponents() {
    ...
    jugadores.setForeground(new java.awt.Color(2, 0, 0));
    jugadores.setModel(
    ...
    musica.setForeground(new java.awt.Color(2, 0, 0));
    musica.setModel(
    ...
    jLabel2.setForeground(new java.awt.Color(2, 0, 0));
    ...
    jugar.setForeground(new java.awt.Color(2, 0, 0));
    jugar.setIcon(
    ...
    jCheckBox1.setForeground(new java.awt.Color(2, 0, 0));
  ...
  private void jugarActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    VentanaTablero ventT =
        new VentanaTablero(
            this.tiempo,
            this.getSistema(),
            this.getJuego(),
            musica.getSelectedValue(),
            this.getVm());
