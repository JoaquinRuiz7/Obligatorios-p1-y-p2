...
public class VentanaMenu extends javax.swing.JFrame {
  ...
  public void borrarPartidasTerminadas() {
    sistema
        ...
        .forEach(
            partida -> {
              if (!partida.getJugador1().tieneFichas()) {
                sistema.getPartidasGuardadas().remove(partida);
              }
            });
  }
  ...
  private void initComponents() {
    ...
    Salir.setForeground(new java.awt.Color(2, 0, 0));
    Salir.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/Imagenes/brazo-levantado.png"))); // NOI18N
    Salir.setText("Salir");
    ...
    rankings.setForeground(new java.awt.Color(2, 0, 0));
    rankings.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/Imagenes/marcador-de-posicion.png"))); // NOI18N
    rankings.setText("Rankings");
    rankings.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    JugarModoVersus.setForeground(new java.awt.Color(2, 0, 0));
    JugarModoVersus.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Imagenes/versus-juego.png"))); // NOI18N
    JugarModoVersus.setText("Modo Versus");
    JugarModoVersus.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    JugarVsPce.setForeground(new java.awt.Color(2, 0, 0));
    JugarVsPce.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Imagenes/roboto-logo.png"))); // NOI18N
    JugarVsPce.setText("Jugar vs Pc");
    JugarVsPce.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    ReanudarPartida.setForeground(new java.awt.Color(2, 0, 0));
    ReanudarPartida.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/Imagenes/simbolo-de-recargar.png"))); // NOI18N
    ReanudarPartida.setText("Reanudar Partida");
    ReanudarPartida.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jLabel3.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fondoMenu.jpg"))); // NOI18N
  ...
  private void JugarVsPceActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_JugarVsPceActionPerformed
  ...
  private void JugarModoVersusActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_JugarModoVersusActionPerformed
  ...
  private void ReanudarPartidaActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_ReanudarPartidaActionPerformed
  ...
  private void rankingsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_rankingsActionPerformed
  ...
  private void registrarJugadorActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_registrarJugadorActionPerformed
